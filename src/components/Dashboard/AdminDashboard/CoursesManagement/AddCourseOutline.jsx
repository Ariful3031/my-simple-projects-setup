...
// import { useGetCourseListQuery, useUpdateCourseOutlineMutation } from "../../../../redux/api/couresApi";
...
//     //         {
//     //             title: "CSS Basics",
//     //             sub_topics: [{ title: "Flexbox" }],
//     //         },
//     //     ],
//     // };
//     const { data: allCoursesData, isLoading: allcourseLoading, error } = useGetCourseListQuery();
...
//         allCoursesData?.find((c) => c._id === selectedCourse)?.topics || [];
...
//         try {
//             const result = await updateOutline({
...
//             Swal.fire({
//                 title: "Error!",
//                 text: err?.data?.message || "Failed to save outline",
//                 icon: "error",
//             });
//         }
//     };
...
//                     <h1 className="text-xl font-bold">Course Outline Manager</h1>
//                 </div>
